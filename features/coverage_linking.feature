Feature: Test Coverage Linking
  ...
  @FC-001 @require-unit:linker @require-e2e
  ...
  @FC-002 @require-unit:linker @require-e2e
  ...
  @FC-003 @require-integration:linker @require-e2e
  ...
  @FC-004 @require-unit:collectors @require-integration:collectors
