Feature: Tool Internals
  ...
  @id:FC-007 @require-unit:parsers @require-e2e:parsers
  ...
  @id:FC-008 @require-unit:aggregator @require-e2e:aggregator @require-integration:aggregator
  ...
  @id:FC-009 @require-unit:renderers @require-e2e:renderers
