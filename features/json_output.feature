Feature: Machine Readable JSON Report
  ...
  @id:FC-010 @require-unit:report_model @require-e2e:report_model @require-integration:report_model
  ...
  @id:FC-010 @require-unit:report_model @require-e2e:report_model
